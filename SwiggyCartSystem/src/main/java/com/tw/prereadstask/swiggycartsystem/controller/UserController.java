...
public class UserController {
	...
	public ResponseEntity<String> userLogin(@RequestParam(value="mobileNumber") long mobileNumber,@RequestParam(value="password") String password) {
		if(userService.isValidUser(mobileNumber,password)) {
